...
def click():
    ...
    def wait_time():
        ...
        target_time = datetime.datetime(current_time.year, current_time.month, current_time.day, 17, 59, 59)
    ...
    for j in range(6):
        ...
        for i in range(300):
            ...
            img_1 = pyautogui.screenshot(region=(933, 380, 10, 10))  # 灰色字体区域
    ...
    if not sign_1:
        ...
        if not sign_2:
            ...
            for i in range(300):
                time.sleep(0.02)
                img = pyautogui.screenshot(region=(871, 632, 20, 5))
